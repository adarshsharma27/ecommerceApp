          ...
          <div className="mx-auto container">
            ...
            <div className="pt-8 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-3">
              <ul className="space-y-4 col-span-3">
                <li className="flex md:flex-row md:items-center md:justify-between flex-col items-start md:gap-4 gap-1">
                  <img
                ...
                <button className="my-4 transition text-white bg-red-500 px-12 py-3  rounded-full hover:bg-red-600">
                  Rest Cart
                </button>
              </ul>
